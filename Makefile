# This Makefile is for the Mail::Outlook extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Mail/Outlook.pm]
#     AUTHOR => [q[Barbie <barbie@cpan.org>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[Mail::Outlook]
#     NO_META => q[1]
#     PREREQ_PM => { Test::More=>q[0.70], IO::File=>q[0], File::Basename=>q[0], Win32::OLE::Const=>q[0], Win32::OLE=>q[0], Cwd=>q[0] }
#     VERSION_FROM => q[lib/Mail/Outlook.pm]
...
TO_INST_PM = lib/Mail/Outlook.pm \
	lib/Mail/Outlook/Folder.pm \
	lib/Mail/Outlook/Message.pm

PM_TO_BLIB = lib/Mail/Outlook.pm \
	blib\lib\Mail\Outlook.pm \
	lib/Mail/Outlook/Message.pm \
	blib\lib\Mail\Outlook\Message.pm \
	lib/Mail/Outlook/Folder.pm \
	blib\lib\Mail\Outlook\Folder.pm
...
DISTNAME = Mail-Outlook
DISTVNAME = Mail-Outlook-0.16
...
Outlook.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"Mail::Outlook\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
ppd :
	...
	$(NOECHO) $(ECHO) "    <ABSTRACT>mail module to interface with Microsoft (R) Outlook (R).</ABSTRACT>" >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"Test::More\" VERSION=\"0.7\" />" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"Win32::OLE\" />" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"Win32::OLE::Const\" />" >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({{@ARGV}}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/Mail/Outlook.pm blib\lib\Mail\Outlook.pm \
	  lib/Mail/Outlook/Message.pm blib\lib\Mail\Outlook\Message.pm \
	  lib/Mail/Outlook/Folder.pm blib\lib\Mail\Outlook\Folder.pm 
